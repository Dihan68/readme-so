...
public class Quiz implements ActionListener {
    ...
    String[] questions = {
            ...
            "Which is an official language for Android Development",
    ...
    String[][] options = {
            ...
            {"Steve Jobs", "Bill Gates", "Your mum", "Elon Musk"},
            {"Java", "Kotlin", "C++","Javascript"},
            {"try catch finally", "IOException", "AutoCloseable", "Streams"},
            {"for (String i : StringList)", "foreach (String i : StringList)", "StringList.forEach()","List.for()"}
    ...
    public Quiz() {
        ...
        number_right.setForeground(new Color(0, 204, 255));
        ...
        percentage.setForeground(new Color(0, 217, 255));
